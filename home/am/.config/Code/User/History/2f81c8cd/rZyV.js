...
import { $qs, crudder, alerter } from "../libs/utils";
...
export class SCSSolicitud extends SCSRequisicionBase {
  ...
  render_form(create=false){
    ...
    let $status = $qs(this.$form, '[name="status"]');
    ...
    new MutationObserver(function(){
      ...
      if($status.value){
        ...
        console.log("aft value")
    }.bind(this)).observe($status, {childList: true, attributes: true});
