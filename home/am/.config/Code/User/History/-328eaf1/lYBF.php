...
class SolicitudViaticoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'cod_especifica_gasto.required' => 'El código del tipo de gasto es obligatorio.',
            'cod_especifica_gasto.string' => 'El código del tipo de gasto debe ser una cadena de texto.',
            'cod_especifica_gasto.max' => 'El código del tipo de gasto no debe superar los 10 caracteres.',
