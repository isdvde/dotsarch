        ...
        if (id) {
          ...
          //  console.log(formData)
            ...
            for (let i = 0; i < detalles_viaticos.length; i++) {
                ...
                formData.append("detalles["+i+"][total]", detalles_viaticos[i].querySelector(".total").value);
                formData.append("detalles["+i+"][cantidad]", detalles_viaticos[i].querySelector(".cantidad").value);                
