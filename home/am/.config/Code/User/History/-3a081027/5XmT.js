...
const form_inputs = [
  ...
  { type: "text", title: "Cedula", name: "cedula", size: 3, single: false, validate: {
    required: '',
    pattern: "([vV])(-){1}([0-9]{1,2})([0-9]{3}){2}",
    title: "Ingrese con formato: V-12345678",
  }},

  { type: 'select', title: "Gge", name: "gge", size: 4, single: false, options: [ 'SOLTERO', 'CASADO', 'DIVORCIADO', 'VIUDO' ] },

  { type: 'select', title: "Gge", name: "gge", size: 4, single: false, options: ['M', 'F'] },
  ...
  { type: "month", title: "Año Egreso", name: "anno_egreso", size: 4},
  ...
  { type: "date", title: "Fecha Ingreso", name: "fecha_ingreso", size: 3, validate: {
    required: '',
  }},
...
let $select = new SelectComponent({
  title: "Gge", name: "gge", size: 4, single: false, options: [ 'SOLTERO', 'CASADO', 'DIVORCIADO', 'VIUDO' ]
});
