...
const form_inputs = [
  ...
  { type: "text", title: "Cedula", name: "cedula", size: 2, single: false, validate: {
    required: '',
  ...
  { type: "text", title: "Nombres", name: "nombres", size: 5, validate: {
    required: '',
    pattern: "([a-zA-Z\\\s])*",
  ...
  { type: "text", title: "Apellidos", name: "apellidos", size: 5, validate: {
    required: '',
    pattern: "([a-zA-Z\\\s])*",
    title: "Solo Letras y espacios",
  }},
...
let $select = new SelectComponent({
  title: "Gge", name: "gge", size: 4, single: false},
  );
