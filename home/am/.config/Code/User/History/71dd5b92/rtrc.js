...
const form_inputs = [
  ...
  { type: "text", title: "Dependencia Solicitante", name: "codigo_dependencia_solicitante", size: 4 },
...
window.onload = async function(){
  ...
  let codigo_dependencia_solicitante = await axios('/api/compras/unidad-ejecutora').then(res => res.data.data.cod_unidad_ejecutora);
