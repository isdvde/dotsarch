...
// let lineas = (await fetch('/api/compras/linea').then(res => res.json())).data;
// let unidades = (await fetch('/api/compras/unidad-medida').then(res => res.json())).data;
...
const form_inputs = [
  ...
  { type: "select_search", title: "Linea", name: "linea", size: 4, url: '/api/compras/linea', value: 'id',
    label: ['descripcion']
  },

  { type: "select_search", title: "Unidad de Medida", name: "unidad_medida", size: 4, url: '/api/compras/unidad-medida', 
    value: 'id', label: ['descripcion']
  },
