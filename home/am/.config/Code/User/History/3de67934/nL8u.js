...
const form_inputs = [
  ...
  { type: "select_search", title: "Linea", name: "linea", size: 4, options: {
    text: 'descripcion',
    value: 'id',
    data: lineas
  }},

  { type: "select_search", title: "Unidad de Medida", name: "unidad_medida", size: 4, options: {
    text: 'descripcion',
    value: 'id',
    data: unidades
  }},
