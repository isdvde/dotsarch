...
import { InputFactory } from "../libs/factories/scs-input-factory";
...
class SCSDetalleServicios extends SCSDetalle {
  ...
  create_detalle(opts) {
    ...
    let $centro_costo = new InputFactory('select_search').create({
