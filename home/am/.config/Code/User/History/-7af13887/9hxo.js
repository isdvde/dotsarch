...
export class SCSSelectSearch extends HTMLElement {
	...
	constructor(opts) {
		...
		this.$search.setAttribute('placeholder', this.opts.placeholder || "Buscar una opcion...");
		this.$label.textContent = this.opts.title || "";

		this.$search.style.fontSize = "0.9em";
		this.$select.style.fontSize = "0.9em";
	...
	set_disabled(){
		...
		this.$search.setAttribute("readonly", "disabled");
	}
