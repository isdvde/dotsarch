...
class SCSDetalleBienes extends SCSDetalle {
  ...
  async create_detalle(art_id, opts) {
    ...
    let $cant = new InputFactory('default').create({ type: "number", size: 2, placeholder: "Cant" });
    let $articulo = new InputFactory('default').create({ type: "text", size: 3, placeholder: "Articulo" });
    let $codigo = new InputFactory('default').create({ type: "text", size: 3, placeholder: "Codigo" });
    let $um = new InputFactory('default').create({ type: "text", size: 3, placeholder: "Unidad Medida" });
...
class SCSDetalleServicios extends SCSDetalle {
