...
export class SCSSelectSearch extends HTMLElement {
	...
	constructor(opts) {
		...
		this.innerHTML = `
			...
			<div class="d-flex">
				<input val type="text" class="pl-2 py-2 text-gray-700 border h-10 border-gray-300 focus-visible:outline-none focus-visible:border-blue-600 focus:border-blue-600 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm w-100" disabled>
				<!--<button clean_button class="btn btn-danger btn-border btn-round border clean-button">x</button>-->
