...
export class Pagination extends HTMLElement {
	...
	update(pagination) {
		...
		// console.log(this.update_actions(pagination)[pagination.current_page])

		// this.update_actions(pagination)[pagination.current_page]() || this.update_actions(pagination)["default"]();
		// let action = this.update_actions(pagination)[pagination.current_page] || this.update_actions(pagination)["default"];
		// action();
		(this.update_actions(pagination)[pagination.current_page.toString()] || this.update_actions(pagination)["default"])();
	}
