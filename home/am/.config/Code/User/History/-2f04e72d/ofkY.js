...
export class SelectSearchComponent extends HTMLElement {
	...
	constructor(opts) {
		...
		this.innerHTML = `
			...
			<div class="d-flex">
				<input type="text" class="form-control value" name="value" disabled>
				<button type="submit" class="btn btn-danger float-left clean-button">x</button>
			</div>
			<input type="text" class="form-control search" name="search" placeholder="Buscar una opcion...">
...
customElements.define('scs-select-search', SelectSearchComponent);
