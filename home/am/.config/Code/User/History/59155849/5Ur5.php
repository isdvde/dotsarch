    ...
    public function index(Request $request)
    {
        ...
        if($query_params){
            ...
            foreach($query_params as $key => $val){
                match($key){
                    'linea' => $q->join('lineas', 'lineas.id', '=', 'articulos.linea_id')->select('articulos.*','unidades_medidas.descripcion AS unidad_medida','lineas.descripcion AS linea'),
                    default => $q->where($key, '=', $val),
                };
