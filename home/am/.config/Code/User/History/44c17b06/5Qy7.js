...
import { InputComponent } from "../components/scs-input";
import { SelectComponent } from '../components/scs-select.js';
import { SelectSearchComponent } from '../components/scs-select-search.js';
...
const form_inputs = [
  ...
  { type: "text", title: "Linea", name: "descripcion", size: 4, validate: {
    required: '',
    pattern: "([a-zA-Z\\\s])*",
    title: "Solo Letras y espacios",
  }},

  { type: "text", title: "Unidad de Medida", name: "descripcion", size: 4, validate: {
    required: '',
    pattern: "([a-zA-Z\\\s])*",
    title: "Solo Letras y espacios",
  }},
