...
export class TableComponent extends HTMLElement {
			...
			<div>
				...
				<div></div>
					...
					<div header__button_container >
						<!-- <button class="btn btn-primary btn-border btn-round border px-4 py-2 card-header__create-button">
	...
	get_url() {
		let page_query= `_page=${this.current_page}&_per_page=10`;
