...
const form_inputs = [
  ...
  { type: "text", title: "Descripcion", name: "descripcion", size: 8, validate: {
    required: '',
    pattern: "([a-zA-Z\\\s])*",
  ...
  { type: "select_search", title: "Linea", name: "linea", size: 6, url: '/api/compras/linea', value: 'id',
    label: ['descripcion'], required: true
  },

  { type: "select_search", title: "Unidad de Medida", name: "unidad_medida", size: 6, url: '/api/compras/unidad-medida', 
    value: 'id', label: ['descripcion'], required: true
  },


  { type: "text", title: "Cod. CCCE", name: "codigo_ccce", size: 3, validate: {
    pattern: "([a-zA-Z\\\s])*",
    title: "Solo Letras y espacios",
  }},
