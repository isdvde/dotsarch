...
const form_inputs = [
  ...
  { type: "select", title: "Prioridad", name: "prioridad", size: 4, options: {
    text: 'text',
    value: 'text',
    data: prioridad
  }},

  { type: "date", title: "Fecha Recepcion", name: "fecha_recepcion", size: 4},
...
function render_form($table, type, create=false) {
  ...
  console.log("creo detalles si crear")
  ...
  console.log("agrego formulario a root")
