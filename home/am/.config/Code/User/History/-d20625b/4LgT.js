...
class SCSDetalleServicios extends SCSDetalle {
  ...
  create_detalle(opts) {
    ...
    let $centro_costo = new SCSInputFactory('select_search').create({
    ...
    let $cant = new SCSInputFactory('default').create({ type: "number", size: 2, placeholder: "Cant" });
