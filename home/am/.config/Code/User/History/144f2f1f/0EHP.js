...
$cod_origen.placeholder = "Buscar Buscar codigo origen";

export const $cod_origen_reset = document.createElement("button");
$cod_origen_reset.classList.add("btn","btn-primary","btn-border","btn-round","border","px-4","py-2","guardar-btn")
$cod_origen_reset.textContent = 'Reset'
$cod_origen_reset.style.display = 'none'
...
export const $select_ficha = clonarNodo($cloneForm, 'select');
