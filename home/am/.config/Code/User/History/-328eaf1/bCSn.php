...
class SolicitudViaticoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'cod_centro_costo.required' => 'El código del tipo de gasto es obligatorio.',
            'cod_centro_costo.string' => 'El código del tipo de gasto debe ser una cadena de texto.',
            'cod_centro_costo.max' => 'El código del tipo de gasto no debe superar los 10 caracteres.',
