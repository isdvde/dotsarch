...
$pasaje.appendChild(new Option("Seleccione el Tipo de Pasaje","" ));
$pasaje.appendChild(new Option("AEREO","AEREO" ));
$pasaje.appendChild(new Option("TERRESTRE","TERRESTRE" ));

export const $divPasaje = document.createElement("div");
